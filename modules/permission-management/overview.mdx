...
| --- | --- | --- | --- |
| Domain.Shared | `IsGrantedRequest` / `IsGrantedResponse` | `Volo.Abp.PermissionManagement.Domain.Shared/Volo/Abp/PermissionManagement/IsGrantedRequest.cs` | [HTTP API](/modules/permission-management/http-api#isgrantedrequest-and-isgrantedresponse) |
