...
description: "IdentityUserAppService, IdentityRoleAppService, IdentityUserLookupAppService, IdentityUserIntegrationService, the AutoMapper profile, IdentityPermissions, and the application module's [DependsOn] graph."
---
