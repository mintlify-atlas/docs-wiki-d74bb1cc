---
title: "Identity HTTP API: Controllers & Typed Client Proxies"
sidebarTitle: "HTTP API"
description: "Routes for IdentityUserController, IdentityRoleController, the integration controller, and the typed ClientProxy classes in HttpApi.Client."
---
