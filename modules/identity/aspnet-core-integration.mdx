...
description: "How AbpIdentityAspNetCoreModule wires AbpSignInManager, AbpSecurityStampValidator, LinkUserTokenProvider, and cookie authentication on top of ASP.NET Core Identity for ABP applications."
---
