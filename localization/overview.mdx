...
| `Volo.Abp.Localization/Resources/AbpLocalization/*.json` | 25+ shipped culture files (ar, cs, de, en, en-GB, es, fa, fr, hi, hr, hu, is, it, nl, pl-PL, pt-BR, ro-RO, ru, sk, sl, tr, vi, zh-Hans, zh-Hant…). |
