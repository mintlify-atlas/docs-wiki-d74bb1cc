...
The file contains 165 `<PackageVersion>` entries — every transitive dependency the framework cares about is pinned here. Highlights by family:
...
| `Directory.Packages.props` | Yes | All 165 transitive `<PackageVersion>` pins, Central Package Management toggle |
